...
const reducer = (state = initialState, action) => {
    switch (action.type) {
            ...
            return {
                ...
                dates: state.dates.map((date, index) => {
                    return date.id === action.payload.id
                        ? { ...date, description: action.payload.description, budget: action.payload.budget }
                        : date;
                }),
            };
        ...
        case DEL_GIFT_WISH:
            return { ...state, wishs: state.wishs.filter(item => item.id !== action.payload) };
        case ADD_GIFT:
        ...
        case DEL_REQUEST:
            return {
                ...state,
                user: { ...state.user, request: state.user.request.filter(item => item.id !== action.id) },
            };
        case WAIT:
        ...
        case UPDATE_GIFT:
            return {
                ...state,
                gifts: state.gifts.map(gift => (gift.id === action.payload.id ? action.payload : gift)),
            };
