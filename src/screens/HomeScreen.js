        ...
        return (
            <>
                                                ...
                                                <Grow in={true} timeout={300 * index} key={index}>
                                                    <>
                                                        <ListItem alignItems="flex-start">
                                                            <ListItemText
                                                                primary={
                                                                    this.props.user.request[index].user.username +
                                                                    ' vous veut dans ces contacts'
                                                                }
                                                            />
                                                            <ListItemIcon
                                                                onClick={() => {
                ...
                <Route
                    exact
                    path="/login"
                    render={() => (this.props.token === null ? <Login /> : <Redirect to="/home" />)}
                />
                <Route exact path="/logout" render={() => <Redirect to="/" />} />
                <Route
                    exact
                    path="/registration"
                    render={() => (this.props.token === null ? <Registration /> : <Redirect to="/home" />)}
                />
                ...
                <Route
                    exact
                    path="/"
                    render={() => (this.props.token !== null ? <Redirect to="/home" /> : <Redirect to="/login" />)}
                />
            </>
        );
    }
