        ...
        return(
            <div className={classes.container}>
                <List className={classes.root} >
                    ...
                    {this.props.wishs.length > 0 ? this.props.wishs.map((item, index) => {
                        return  <Grow in={true} timeout={400*index<6000?500*index:400} key={index} ><div >
                            <ListItem alignItems="flex-start">
                                ...
                                {this.props.idContact ? <></> :
                                    <>
                                        <IconButton aria-label={"More"} aria-haspopup={"true"} onClick={(e) => {
                                        ...
                                        <Menu anchorEl={menu} open={open} onClose={this.handleClose}>
                                            ...
                                            <MenuItem onClick={() => {
                                                this.props.dispatch(loadGift(this.state.id, true))
                                            }}>
                                                Modifier
                                            </MenuItem>
                                        </Menu>
                ...
                {this.props.idContact ? <></> :
                    <>
                        ...
                        <Dialog open={this.state.confDel} disableEnforceFocus >
                            ...
                            <DialogActions>
                                <Button onClick={()=>{
                                     this.props.dispatch(delGift(this.state.id))
