...
class modalContact extends Component {
    ...
    render(){
        ...
        return(
            ...
            >
                <DialogTitle id="responsive-dialog-title">{this.props.contact.name + ' ' + this.props.contact.surname}</DialogTitle>
                ...
                <DialogContent>
                    ...
                    >
                        <Typography component="div" dir={theme.direction} style={{ padding: 8 * 3 }}>
                            <p><b>Nom :</b> {this.props.contact.name}</p>
                            <p><b>Prénom :</b> {this.props.contact.surname}</p>
                            <p><b>Utilisateur associé :</b> {this.props.contact.link? this.props.contact.link.username:''}</p>
                            <p><b>Date d'anniversaire :</b> {this.props.contact.birthday? birthday.getDate()+'/'+(birthday.getMonth()+1)+'/'+birthday.getFullYear() :'' }</p>
                        </Typography>
                                    ...
                                    return <div key={index}>
                                            <ListItem alignItems="flex-start">
                                                <ListItemText
                                                    ...
                                                    onClick={()=> {console.log('modalGift('+item.id+')')}}
                                                />
                                            </ListItem>
                                        <Divider variant="fullWidth"/>
                                    </div>
                            ...
                            <List className={classes.root}>
                                {this.props.contact.dates.map((item, index)=>{
                                    ...
                                    return <div key={index}>
                                        <ListItem alignItems="flex-start">
                                            <ListItemText
                                                primary={date.getDate()+'/'+(date.getMonth()+1)+'/'+date.getFullYear()}
                                                secondary={
                                                    <>
                                                        <Typography component="span" className={classes.inline} color="textPrimary">
                                                ...
                                                onClick={()=> {console.log('modalDate('+item.id+')')}}
                                            />
                                        </ListItem>
                                        <Divider variant="fullWidth"/>
                                    </div>
